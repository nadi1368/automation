...
$this->title = Module::t('module', 'Au Letters Output');
...
<div class="au-letter-index card">
    <div class="panel-group m-bot20" id="accordion">
        <div class="card-header d-flex justify-content-between">
            ...
            <div>
                <?= Html::a(Module::t('module', 'Create Letter Output Between System'), ['au-letter-output/create', 'type' => AuLetter::INPUT_OUTPUT_SYSTEM], ['class' => 'btn btn-success']) ?>
                <?= Html::a(Module::t('module', 'Create Letter Output Out of System'), ['au-letter-output/create'], ['class' => 'btn btn-success']) ?>
            </div>
        </div>
