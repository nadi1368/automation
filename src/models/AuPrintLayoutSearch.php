...
/**
 * AuPrintLayoutSearch represents the model behind the search form of `hesabro\automation\models\AuPrintLayout`.
 */
class AuPrintLayoutSearch extends AuPrintLayout
{
    /**
     * {@inheritdoc}
     */
    public function rules()
    {
        return [
            ...
            [['title', 'logo', 'additional_data'], 'safe'],
        ];
    }
